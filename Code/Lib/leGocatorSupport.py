...
def gocator_adjust_handcoded(version):
  lePrint('gocator_adjust_handcoded starting...')
  dx = 0.0
  dy = 0.0
  dz = 0.0
  drx = 0.0
  ...
  if version == 1:
    lePrint('Version 1 Translation Only')
    ...
    lePrint('Version 2 Rotation Only')
    ...
    lePrint('Version 3 translate, Pause 1sec, Rotate')
